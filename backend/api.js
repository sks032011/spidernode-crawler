...
// 🔥 The Graceful Stop: Clears waiting jobs but keeps your database intact
...
app.post('/api/reset', async (req, res) => {
    try {
        console.log('⚠️ INITIATING SYSTEM RESET...');
    ...
    if (!metricsInterval) {
        metricsInterval = setInterval(async () => {
            try {
                ...
                console.error('⚠️ Metrics error:', error.message);
            }
        }, 1000);
    }
...
// When you hit CTRL+C to stop the server:
